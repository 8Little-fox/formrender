...
const FormSandbox2 = lazy(() => import(/* webpackChunkName: "form2" */ '@/views/form2/sandbox/index'));
const TableRender = lazy(() => import(/* webpackChunkName: "form2" */ '@/views/table/index'));
    ...
    children: [
      {
        path: '/form-sandbox',
        meta: { title: '表单设计', showBreadcrumb: true, layoutStyle: ELayoutStyle.Mix },
        component: FormSandbox2,
      },
    ],
  },
  {
    path: '/form2',
    redirect: '/form2/sandbox',
  },
  {
    path: '/table',
    meta: { title: '表格管理', showBreadcrumb: true },
